...
const newCellsTable2 = checkAround(
  newCellsTable,
  columnsQuantities,
  linesQuantities
);
...
const newCellsTable3 = checkAround(
  newCellsTable2,
  columnsQuantities,
  linesQuantities
);
...
const newCellsTable4 = checkAround(
  newCellsTable3,
  columnsQuantities,
  linesQuantities
);
...
const newCellsTable5 = checkAround(
  newCellsTable4,
  columnsQuantities,
  linesQuantities
);
...
const newCellsTable6 = checkAround(
  newCellsTable5,
  columnsQuantities,
  linesQuantities
);
...
const newCellsTable7 = checkAround(
  newCellsTable6,
  columnsQuantities,
  linesQuantities
);
...
const newCellsTable8 = checkAround(
  newCellsTable7,
  columnsQuantities,
  linesQuantities
);
...
const newCellsTable9 = checkAround(
  newCellsTable8,
  columnsQuantities,
  linesQuantities
);
